...
Now a simple task - in our code at the statusbar there are 9 icons in the center and in our g:dx/logo folder there are logo for those 9 web tools and there is 3 tyles of icons for those 9 icons light, dark, transparent so please use that transparent icon for the favicons for the g:dx/code/web 9 web project and 7 project in there is nextjs project and Whiteboard and Shader project is dx www web framework project and there for the 9 project there can different branding, names and favicons but it should be just there folder name like for the Whiteboard project the favicon will be the web tools Whiteboard transparent favicon and the name will just be Whiteboard not Dx www Whiteboard or anything other and also change that if its on the ui and do this branding for all 9 projects even the shader and the 7 nextjs projects and create a script in our g:dx/web.sh and in that create all 7 web tools nextjs project and for the www Whiteboard and Shader project run "dx build" in that folder and it will work - so for the 7 nextjs projects please copy the ouput folder to our "g:dx/code/asssets/web" folder and replace current folder and for the Whiteboard and Shader dx www project please copy the "g:dx/code/web/Whiteboard/.dx/www/output" and "g:dx/code/web/Shader/.dx/www/output" to "g:dx/code/asssets/web/whiteboard" and "g:dx/code/asssets/web/shader" folder
